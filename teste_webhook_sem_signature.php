...
$testName = "TESTE JSON BEM FORMADO $timestamp";
$testEmail = "teste.json.bem.formado.$timestamp@teste.com";

// Payload de teste BEM FORMADO (formato Webflow API V2)
$testPayload = [
    ...
    'payload' => json_encode([
        ...
        'data' => json_encode([
            ...
            'ANO' => '2023',
            'MARCA' => 'Honda',
            'GCLID_FLD' => 'gclid_teste_logs_sem_sig_' . $timestamp,
            'SEQUENCIA_FLD' => ''
        ]),
        'submittedAt' => date('c'),
        'id' => '68faa7b123456789',
...
echo "🚀 EXECUTANDO TESTE DO WEBHOOK COM JSON BEM FORMADO\n";
echo "===================================================\n";
echo "📋 Dados do teste:\n";
echo "   Nome: $testName\n";
